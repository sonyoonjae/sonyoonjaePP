...
#find1{margin: 36px 0 0 0;}
#request{margin: -19px 0 0 0;}
</style>
...
<tr>
	<td style="width:700px;height:78px;padding:0;margin:0;vertical-align:top;">
		...
		<img src="../images/email/pass2.PNG" alt="문의하신 회원님 password " width="620px" margin="0px 20px 40px 38px" id="find"/></p>
	</td>
</tr>
<tr>
	<td style="width:700px;height:196px;padding:0;margin:0;vertical-align:top;">
		...
		<tr>
			<td style="width:618px;height:235px;padding:0;margin:0;vertical-align:top;font-size:0;line-height:0;background:#f9f9f9;">
				...
				<img src="../images/email/request4.png" alt="비밀번호 찾기를 요청하셨습니다." width="620px"margin="30px 0 0 0"padding="0" text-align="center" id="request"/></p></p>
				<p style="width:620px;margin:10px 0 0 0;padding:0;text-align:center;color:#888888;font-size:12px;line-height:1;">PASSWORD는 임시 PASSWORD이므로 홈페이지 로그인 후 다시 수정해 주십시오.</p>
						<p style="width:620px;margin:28px 0 0 0;padding:0;text-align:center;color:#666666;font-size:12px;line-height:1;"><strong>임시 패스워드 : <span style="color:darkblue;line-height:1;font-size:20px;">${session_temp_password }</span></strong></p>
				<p style="width:620px;margin:30px 0 0 0;padding:0;text-align:center;color:#888888;font-size:12px;line-height:1.4;">RUNNER'Z에서는 고객님께 보다 나은 서비스를 제공하기 위해 항상 노력하고 있습니다.<br/>앞으로 많은 관심 부탁드립니다.</p>
			</td>
		</tr>
		</table>	
	</td>
